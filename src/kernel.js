...
export const LINUX_BOOT_HDR_SETUP_SECTS = 0x1F1;
export const LINUX_BOOT_HDR_SYSSIZE = 0x1F4;
export const LINUX_BOOT_HDR_VIDMODE = 0x1FA;
export const LINUX_BOOT_HDR_BOOT_FLAG = 0x1FE;
export const LINUX_BOOT_HDR_HEADER = 0x202;
export const LINUX_BOOT_HDR_VERSION = 0x206;
export const LINUX_BOOT_HDR_TYPE_OF_LOADER = 0x210;
export const LINUX_BOOT_HDR_LOADFLAGS = 0x211;
export const LINUX_BOOT_HDR_CODE32_START = 0x214;
export const LINUX_BOOT_HDR_RAMDISK_IMAGE = 0x218;
export const LINUX_BOOT_HDR_RAMDISK_SIZE = 0x21C;
export const LINUX_BOOT_HDR_HEAP_END_PTR = 0x224;
export const LINUX_BOOT_HDR_CMD_LINE_PTR = 0x228;
export const LINUX_BOOT_HDR_INITRD_ADDR_MAX = 0x22C;
export const LINUX_BOOT_HDR_KERNEL_ALIGNMENT = 0x230;
export const LINUX_BOOT_HDR_RELOCATABLE_KERNEL = 0x234;
export const LINUX_BOOT_HDR_MIN_ALIGNMENT = 0x235;
export const LINUX_BOOT_HDR_XLOADFLAGS = 0x236;
export const LINUX_BOOT_HDR_CMDLINE_SIZE = 0x238;
export const LINUX_BOOT_HDR_PAYLOAD_OFFSET = 0x248;
export const LINUX_BOOT_HDR_PAYLOAD_LENGTH = 0x24C;
export const LINUX_BOOT_HDR_PREF_ADDRESS = 0x258;
export const LINUX_BOOT_HDR_INIT_SIZE = 0x260;

export const LINUX_BOOT_HDR_CHECKSUM1 = 0xAA55;
export const LINUX_BOOT_HDR_CHECKSUM2 = 0x53726448;

export const LINUX_BOOT_HDR_TYPE_OF_LOADER_NOT_ASSIGNED = 0xFF;

export const LINUX_BOOT_HDR_LOADFLAGS_LOADED_HIGH = 1 << 0;
export const LINUX_BOOT_HDR_LOADFLAGS_QUIET_FLAG = 1 << 5;
export const LINUX_BOOT_HDR_LOADFLAGS_KEEP_SEGMENTS = 1 << 6;
export const LINUX_BOOT_HDR_LOADFLAGS_CAN_USE_HEAPS = 1 << 7;
